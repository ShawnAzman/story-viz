...
function AboutModal() {
  ...
  return (
    ...
    >
      ...
      <p>
        🎗️ Each "ribbon" represents a <b>{themeView ? "theme" : "character"}</b>{" "}
      ...
      <p>
        ✨ Our storyline visualizations are further customizable with the by
        opening the{" "}
        <i>
      ...
      <p>
        💡 If you need help at any time, click the{" "}
